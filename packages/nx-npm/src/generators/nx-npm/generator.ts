...
interface NormalizedSchema extends NxNpmGeneratorSchema {
  projectName: string;
  projectRoot: string;
...
function normalizeOptions(host: Tree, options: NxNpmGeneratorSchema): NormalizedSchema {
