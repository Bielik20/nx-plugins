...
interface NormalizedSchema extends NxJestPlaywrightGeneratorSchema {
  projectName: string;
  projectRoot: string;
...
function normalizeOptions(host: Tree, options: NxJestPlaywrightGeneratorSchema): NormalizedSchema {
